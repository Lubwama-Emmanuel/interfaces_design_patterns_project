...
// Source: github.com/Lubwama-Emmannuel/Interfaces/fileSystem (interfaces: IDatabase)
...
func (m *MockIDatabase) Create(arg0 string) error {
	m.ctrl.T.Helper()
...
func (m *MockIDatabase) Delete() error {
	m.ctrl.T.Helper()
...
func (mr *MockIDatabaseMockRecorder) Delete() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Delete", reflect.TypeOf((*MockIDatabase)(nil).Delete))
}

// Read mocks base method.
func (m *MockIDatabase) Read() (string, error) {
	m.ctrl.T.Helper()
...
func (mr *MockIDatabaseMockRecorder) Read() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Read", reflect.TypeOf((*MockIDatabase)(nil).Read))
}

// Update mocks base method.
func (m *MockIDatabase) Update(arg0 string) error {
	m.ctrl.T.Helper()
